...
const memoryEntrySchema = new mongoose.Schema({
  ...
  // Dense vector embedding generated by nomic-embed-text (or similar).
  // Stored alongside the entry for semantic (cosine) similarity search.
  // Populated asynchronously after the entry is written — may be absent
  // on entries created before the embedding feature was introduced.
  embedding: {
    type: [Number],
  },
  metadata: {
