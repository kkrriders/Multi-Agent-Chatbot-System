...
export function Topbar({ title, showSearch = false }: Props) {
  ...
  return (
    <header className="hidden md:flex justify-between items-center px-6 h-16 console-nav border-b border-outline-variant/10 fixed top-0 right-0 w-[calc(100%-16rem)] z-30">
      {title ? (
