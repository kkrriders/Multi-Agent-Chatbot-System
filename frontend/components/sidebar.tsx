...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col py-6 px-4 console-nav border-r border-outline-variant/10 shadow-sm fixed left-0 top-0 bottom-0 h-full w-64 z-40">
      ...
      {/* Mobile Top Bar */}
      <header className="md:hidden flex justify-between items-center w-full px-4 h-16 console-nav border-b border-outline-variant/10 fixed top-0 z-50">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 w-full console-nav border-t border-outline-variant/10 flex justify-around items-center h-16 z-50 px-2 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.05)]">
