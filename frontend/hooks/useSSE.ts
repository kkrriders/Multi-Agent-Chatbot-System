...
import type { IntegritySignals } from '@/lib/api'
...
export type SSEEvent =
  ...
  | { type: 'integrity-update'; answerId: string; integrityScore: number; integrityFlag: 'CLEAN' | 'SUSPICIOUS' | 'LIKELY_AI'; integritySignals?: IntegritySignals | null }
