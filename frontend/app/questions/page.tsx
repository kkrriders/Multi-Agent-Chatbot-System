    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-14">
        <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          {showForm && (
            <form onSubmit={handleCreate} className="glass-card rounded-xl p-5 mb-6 space-y-4">
          ...
          {loading ? (
            ...
            <div className="space-y-2">
              {items.map(q => (
                <div key={q.id} className="flex items-start gap-4 glass-card rounded-xl px-4 py-3">
