...
export default function LeaderboardPage() {
  ...
  const [leaderboard, setLeaderboard] = useState<{ _id: string; targetRole?: string; mode: string; overallScore: number; completedAt: string }[]>([])
  ...
  useEffect(() => {
    Promise.all([
      ...
      progressApi.leaderboard().then(d => setLeaderboard(d.leaderboard as typeof leaderboard)),
