            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2.5 px-4 bg-surface-container-lowest border border-outline-variant/40 rounded-lg hover:bg-surface-container-low hover:border-outline-variant transition-colors shadow-sm text-sm font-semibold text-on-surface"
                >
                  {icon}{label}
                </button>
              ))}
