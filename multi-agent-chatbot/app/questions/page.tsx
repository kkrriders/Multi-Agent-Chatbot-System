...
export default function QuestionsPage() {
  ...
  const [form, setForm] = useState({ text: '', category: 'technical' as const, role: 'General', difficulty: 'medium' as const, expectedKeywords: '' })
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      await questionsApi.create({
        ...
        expectedKeywords: form.expectedKeywords.split(',').map(s => s.trim()).filter(Boolean) as any,
      })
